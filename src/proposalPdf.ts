...
import {
  allocateProposalCosts,
  type ProposalLineAllocation,
} from './proposalPricing';

export { allocateProposalCosts } from './proposalPricing';
export type { ProposalLineAllocation } from './proposalPricing';
