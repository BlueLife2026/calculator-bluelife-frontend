...
export function HealthDepartmentPage({ sidebar }: { sidebar: ReactNode }) {
  ...
  return <div className="page app-page health-page">
    ...
    {showSettings && <section className="health-settings"><div><strong>Ticket intake email</strong><p>Todo correo con la categoría <b>Health deparment</b> se convertirá en un ticket nuevo.</p></div><div className="health-settings-form"><input aria-label="Health Department email" value={email} onChange={(event) => setEmail(event.target.value)} /><button className="primary-button" type="button" onClick={() => setShowSettings(false)}>Save</button></div></section>}
